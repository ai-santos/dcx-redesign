...
;window.Modernizr = function (a, b, c) {
  function C(a, b) {
  ...
  }([, ["@media (", n.join("transform-3d),("), i, ")", "{#csstransforms3d{left:9px;position:absolute}}"].join("")], [, "csstransforms3d"]);p.csstransforms3d = function () {
    ...
    return C(a, "pfx");
  }, g.className = g.className.replace(/\bno-js\b/, "") + (f ? " js " + s.join(" ") : "");return e;
...
(function () {
  ...
  DDD.translate = Modernizr.csstransforms3d ? function (x, y) {
